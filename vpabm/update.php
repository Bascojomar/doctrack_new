...
echo'
    <div class="mx-4 px-2 pb-2">
        <div class="title">
          ...
          $query = "SELECT * FROM tbl_inout WHERE Channel = 'VPABM' AND DocStatus = 'RECEIVED' and DocInOut='IN' ORDER BY CDate DESC";
                        ...
                        while ($rows = $result->fetch_assoc()) 
{
                      ...
                      $currentDate = date("Y/m/d");
                        ...
                        echo "<INPUT type='button' class='btn btn-danger btn-sm' data-reference='" . $rows['Reference'] . "' value='Update'>";
                              echo'</div>';
                        echo "</TD>";
                        echo "</TD>";
                       echo' </tr>
