    ...
    <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-primary text-white">
      <div class="position-sticky">
        <div class="list-group list-group-flush mx-2 mt-3">
          ...
          <a href="vpaapending" id="active" class="list-group-item list-group-item-action py-2 ripple bg-primary text-white fw-semibold" aria-current="true">
...
<main>
    <div class="mx-4 px-2 pb-2">
        <div class="title">
          ...
          <div class="table-container mt-2  px-3 pt-3 ">
          <table id="example" class="table table-striped" style="width:100%">
                        ...
                        $queryload = "SELECT * FROM tbl_inout WHERE DocInOut='IN' and Channel = '$office' and ActionTaken = 'PENDING' ORDER BY CDate DESC";
