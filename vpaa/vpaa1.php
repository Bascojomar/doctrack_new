...
<nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-primary text-white">
  <div class="position-sticky">
    <div class="list-group list-group-flush mx-2 mt-3">
      ...
      <a href="vpaa1" id="active" class="list-group-item list-group-item-action py-2 ripple bg-primary text-white fw-semibold" aria-current="true">
...
$queryload = "SELECT * FROM tbl_inout WHERE Channel = 'VPAA' and DocInOut = 'IN' and DocStatus = 'RECEIVED' ORDER BY CDate DESC";
...
if (isset($_POST['submit'])) {
  ...
  $checkQuery = "SELECT * FROM tbl_inout WHERE Reference = '$reference' and DocInOut = 'IN' and Channel = 'VPAA'";
  $result = $conn->query($checkQuery);

  if ($result->num_rows > 0) {
      // Perform the database update
      $updateQuery = "UPDATE tbl_inout SET CDate = '$date1', DocStatus = 'RECEIVED', Remarks = 'FOR SIGNATURE' WHERE Reference = '$reference' and DocInOut = 'IN' and Channel = 'VPAA'";
