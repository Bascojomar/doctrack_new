...
<nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-primary text-white">
  <div class="position-sticky">
    <div class="list-group list-group-flush mx-2 mt-3">
        ...
        <a href="search" id="active" class="list-group-item list-group-item-action py-2 ripple bg-primary text-white fw-semibold" aria-current="true">
        ...
        if (isset($_POST['submit'])) {
            ...
            if (empty($searchRef)) {
                echo "<script>alert('Please Enter Reference Number')</script>";
                 echo "<script>window.location.href = 'track'</script>";
            } else {
