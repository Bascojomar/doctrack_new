            ...
            <!-- <div class="btn btn-primary pt-2" data-bs-toggle="modal" data-bs-target="#addAcc">
                Add Account
                    ...
                    <table id="example" class="table table-striped" style="width:100%">
                        ...
                        $queryload = "SELECT * FROM tbl_inout WHERE DocInOut='OUT' and Channel = '$office' and DocStatus = 'COMPLETED' ORDER BY CDate DESC";
                        ...
                        if ($resultload->num_rows > 0) {
                            while ($rowsload = $resultload->fetch_assoc()) {
                                ...
                                $documentDate = date("Y-m-d-h:i a ", $from);
                        
                                // Check if the date has changed
                                if ($documentDate != $currentDate) {
                                    // Output a new table header with the new date
                                    echo "<tr class='dateHeader'>";
                                    echo "<td colspan='6' class='bg-warning'>$documentDate</td>";
                                    echo "</tr>";
