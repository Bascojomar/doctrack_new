...
<main>';
        ...
        <div class="col">
            <div class="card text-start bg-warning text-white">
                <div class="card-body">
                    ...
                    <h5 class="card-text">';
                    $queryload = "SELECT COUNT(*) as count FROM tbl_inout WHERE Channel = 'VPABM' AND DocStatus = 'RECEIVED' AND DocInout = 'IN'";
                    $result = mysqli_query($conn, $queryload);
        ...
        <div class="col">
            <div class="card text-start bg-success text-white">
                <div class="card-body">
                    ...
                    $queryload = "SELECT COUNT(*) as count FROM tbl_inout WHERE Channel = 'VPABM' AND DocStatus = 'RELEASED' AND DocInout = 'OUT'";
                    $result = mysqli_query($conn, $queryload);
    ...
    <table class="ms-3">
    ';
    $query = "SELECT * FROM tbl_inout WHERE Channel = 'VPABM'and DocInOut='IN' and DocStatus='RECEIVED' ORDER BY CDate DESC";
