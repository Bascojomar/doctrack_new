  ...
  <div class="position-sticky">
    <div class="list-group list-group-flush mx-2 mt-3">
      ...
      <a href="release" class="list-group-item list-group-item-action py-2 ripple bg-primary text-white fw-semibold">
        ...
        <a href="list" id="active" class="list-group-item list-group-item-action py-2 ripple bg-primary text-white fw-semibold" aria-current="true">
...
<main>
    ...
    CASE 
        ...
        WHEN DATEDIFF(CURDATE(), CDate) < 0 THEN 3
