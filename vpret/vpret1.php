...
<nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-primary text-white">
  <div class="position-sticky">
    <div class="list-group list-group-flush mx-2 mt-3">
      ...
      <a href="vpret1" id="active" class="list-group-item list-group-item-action py-2 ripple bg-primary text-white fw-semibold" aria-current="true">
...
$queryload = "SELECT * FROM tbl_inout WHERE Channel = 'VPRET' and DocInOut = 'IN' and DocStatus = 'RECEIVED' ORDER BY CDate DESC";
...
if (isset($_POST['submit'])) {
  ...
  $checkQuery = "SELECT * FROM tbl_inout WHERE Reference = '$reference'  and DocInOut = 'OUT' and Channel = 'VPABM' and Remarks='SIGNED'";
