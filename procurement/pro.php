...
<nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-primary text-white">
  <div class="position-sticky">
    <div class="list-group list-group-flush mx-2 mt-3">
      ...
      <a href="pro" id="active" class="list-group-item list-group-item-action py-2 ripple bg-primary text-white fw-semibold" aria-current="true">
...
<main>';
    ...
    echo'<div class="mx-4 px-2 pb-2">
      <div class="title d-flex justify-content-between align-items-center">
        ...
        echo "<FORM action='profunc' method='post' onsubmit='return validateSearch();'>";
...
$date1 = date('y/m/d');
    ...
    echo'</div>
                    ...
                    <table>
                        <thead>';
                        $queryload = "SELECT * FROM tbl_inout WHERE Channel = 'PROCUREMENT' and DocInOut = 'IN' and DocStatus = 'RECEIVED' ORDER BY CDate DESC";
