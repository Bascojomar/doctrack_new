    ...
    <div class="position-sticky">
      <div class="list-group list-group-flush mx-2 mt-3">
        ...
        <a href="vpaacomplete" class="list-group-item list-group-item-action py-2 ripple bg-primary text-white fw-semibold">
          ...
          <a href="my_account.php" id="active" class="list-group-item list-group-item-action py-2 ripple bg-primary text-white fw-semibold">
    ...
    echo '<div class="mx-4 px-2 pb-2">
        <div class="title">
          ...
          <div class="col-1 fw-bold col-form-label">Name</div>
              ...
              <FORM action = "my_account" method = "post" onsubmit = "return ValidatePassword()" enctype = "multipart/form-data" name = "frmChangePass">
              <div class="row mx-3 ">
