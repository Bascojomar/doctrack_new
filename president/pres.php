...
<nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-primary text-white">
  <div class="position-sticky">
    <div class="list-group list-group-flush mx-2 mt-3">
      ...
      <a href="pres" id="active" class="list-group-item list-group-item-action py-2 ripple bg-primary text-white fw-semibold" aria-current="true">
...
echo '<div class="table-container mt-2 pt-3 px-3">
...
$queryload = "SELECT * FROM tbl_inout WHERE Channel = 'PRESIDENT' and DocInOut = 'IN' and DocStatus = 'RECEIVED' ORDER BY CDate DESC";
...
if (isset($_POST['submit'])) {
  ...
  // $checkQuery = "SELECT * FROM tbl_inout WHERE Reference = '$reference' and DocInOut = 'OUT' and Channel = 'PROCUREMENT' and Remarks='SIGNED'";
